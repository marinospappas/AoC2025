package mpdev.springboot.aoc2025.model

import com.fasterxml.jackson.annotation.JsonProperty
import java.util.Collections.emptySet

data class PuzzleSolution(
    @JsonProperty("Message")  var message: String = "Advent of Code 2025",
    ...
    @JsonProperty("Solution")  var solution: Set<PuzzlePartSolution> = emptySet()
)
